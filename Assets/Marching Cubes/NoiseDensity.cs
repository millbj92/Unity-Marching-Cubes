...
public class NoiseDensity : DensityGenerator
{
    ...
    public float persistence = .46f;
    public float noiseScale = 3.21f;
    public float noiseWeight = 6.92f;
    public bool closeEdges;
    public float floorOffset = 5.19f;
    public float weightMultiplier = 3.61f;

    public float hardFloorHeight = -2.84f;
    public float hardFloorWeight = 3.05f;
